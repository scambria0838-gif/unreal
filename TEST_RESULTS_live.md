...
| actor count increased | PASS | {'actor_count': 155, 'label_exists': True, 'spawned_actor': {'label': 'SNV2_Smoke_A', 'path': '/Game/SNV2_WP.SNV2_WP:PersistentLevel.StaticMeshActor_UAID_A0AD9F33413A7E0103_1990063065', 'location': [0.0, 0.0, 300.0], 'rotation': [0.0, 0.0, 0.0], 'scale': [1.0, 1.0, 1.0], 'class': 'StaticMeshActor', 'guid': "<Struct 'Guid' (0x00000230C8969850) {}>", 'in_pie_world': False}} |
| spawned path is not a PIE path | PASS | {'actor_count': 155, 'label_exists': True, 'spawned_actor': {'label': 'SNV2_Smoke_A', 'path': '/Game/SNV2_WP.SNV2_WP:PersistentLevel.StaticMeshActor_UAID_A0AD9F33413A7E0103_1990063065', 'location': [0.0, 0.0, 300.0], 'rotation': [0.0, 0.0, 0.0], 'scale': [1.0, 1.0, 1.0], 'class': 'StaticMeshActor', 'guid': "<Struct 'Guid' (0x00000230C8969850) {}>", 'in_pie_world': False}} |
...
| external-actor files were written | PASS | {'added': ['E/8V/8SR1W6QLJ0DN5ENCJR7WY6.uasset'], 'removed': [], 'modified': [], 'count_before': 155, 'count_after': 156} |
